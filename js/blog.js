...
function openArticle(id) {
  ...
  document.getElementById('blogArticleContent').innerHTML = `
    ...
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:24px;flex-wrap:wrap">
      <span style="font-size:11px;color:var(--muted);letter-spacing:1px;text-transform:uppercase;font-weight:600">Partager</span>
      <a href="https://wa.me/?text=${encodeURIComponent(post.title + ' — ' + window.location.href)}" target="_blank" rel="noopener"
        style="display:flex;align-items:center;gap:6px;background:rgba(37,211,102,0.12);border:1px solid rgba(37,211,102,0.3);color:#25d366;border-radius:100px;padding:6px 14px;font-size:11px;font-weight:700;text-decoration:none;transition:all 0.2s;letter-spacing:0.5px"
        onmouseenter="this.style.background='rgba(37,211,102,0.22)'" onmouseleave="this.style.background='rgba(37,211,102,0.12)'">
      ...
      <a href="https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}" target="_blank" rel="noopener"
        style="display:flex;align-items:center;gap:6px;background:rgba(24,119,242,0.12);border:1px solid rgba(24,119,242,0.3);color:#1877f2;border-radius:100px;padding:6px 14px;font-size:11px;font-weight:700;text-decoration:none;transition:all 0.2s;letter-spacing:0.5px"
        onmouseenter="this.style.background='rgba(24,119,242,0.22)'" onmouseleave="this.style.background='rgba(24,119,242,0.12)'">
      ...
      <button onclick="navigator.clipboard.writeText(window.location.href).then(()=>{if(typeof toast==='function')toast('🔗 Lien copié !')})"
        style="display:flex;align-items:center;gap:6px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.12);color:var(--muted);border-radius:100px;padding:6px 14px;font-size:11px;font-weight:700;cursor:pointer;transition:all 0.2s;letter-spacing:0.5px"
        onmouseenter="this.style.background='rgba(255,255,255,0.1)';this.style.color='var(--ice)'" onmouseleave="this.style.background='rgba(255,255,255,0.05)';this.style.color='var(--muted)'">
